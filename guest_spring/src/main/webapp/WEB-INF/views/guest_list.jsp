	...
	<tr>
		<td><br />
			<table style="padding-left: 10px" border=0 cellpadding=0
				cellspacing=0>
				<tr>
					<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b><s:message code="title.list"/></b></td>
				</tr>
			</table>
			<form name="f" method="post">
				...
				<table border="0" cellpadding="0" cellspacing="1" width="590"
					bgcolor="BBBBBB">
					<tr>
						<td width=50 align=center bgcolor="E6ECDE" height="22"><s:message code="list.label.no"/></td>
						<td width=300 align=center bgcolor="E6ECDE"><s:message code="list.label.title"/></td>
						<td width=120 align=center bgcolor="E6ECDE"><s:message code="list.label.name"/></td>
						<td width=120 align=center bgcolor="E6ECDE"><s:message code="list.label.date"/></td>
					</tr>
					...
					<tr>
						...
						<td width=300 bgcolor="ffffff" style="padding-left: 10"><a
							href="guest_view?guest_no=${guest.guest_no}" class="user">
								${guest.guest_title}
						</a></td>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="590">
				<tr>
					<td align="right">
					<input type="button"
					    onclick="guestWriteForm();" value="<fmt:message key="write.button.write"/>" />
					<!--  
					<input type="button"
